...
const sequelize = new Sequelize('postgresql://postgres.qqzmbnpwmmxvjxmixteb:FholMarzo2026@aws-0-sa-east-1.pooler.supabase.com:6543/postgres?supavisor_session_mode=session', {
    dialect: 'postgres',
    logging: false,
    dialectOptions: {
        ssl: {
